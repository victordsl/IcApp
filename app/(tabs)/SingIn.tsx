  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text onPress={()=>navigation.navigate('SingUp' as never)} style={styles.BotaoCadatrar}>
          Não possui conta? Clique aqui para <Text style={{fontWeight:"bold"}}> Cadastrar-se! </Text>
          </Text>
    </View>
  );
}
